...
index_page = Template("""
<html><head><title>$title</title></head><body style="font-family: arial;background:#1877f2;color:#ffffff;margin:50px 0px; padding:0px; text-align:center;">
<style type="text/css">
...
<div style="background: #e9ebee; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); margin: 20px auto; max-width: 600px;">
    <img src="images/fac_logo.png" style="margin:0px auto;" />

    <form action="search" method="get" id="searchbar" style="margin-top: 20px;">
        <input name="q" id="q" type="text" size="30" style="font-size: 16px; padding: 8px;" />
        <input type="submit" value="Search" style="font-size: 20px; padding: 10px; background: #4CAF50; color: #fff; border: none; cursor: pointer; border-radius: 5px;" />
    </form>
...
user_page = Template("""
<html><head><title>My Fazebook Page</title></head><body style="font-family: helvetica;background:#1877f2;color:#000000;margin:0px 0px; padding:0px;">
<style type="text/css">
...
<div style="background: #e9ebee; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); margin: 20px auto; max-width: 600px;">
    <a href="/"><img border="0" src="images/fac_logo_small.png" style="padding: 16px; margin: 0 auto;" /></a>

    <div style="font-size: 2em; padding: 0; text-align: center; margin-bottom: 20px;"><b>$username</b> $lock</div>
...
<html><head><title>List of Fazebook Users</title></head><body style="font-family: helvetica;background:#1877f2;color:#000000;margin:0px 0px; padding:0px;">
<style type="text/css">
A:link {text-decoration: none; color:#000000}
A:visited {text-decoration: none; color:#000000}
A:active {text-decoration: none}
...
<html><head><title>Search results</title></head><body style="font-family: helvetica;background:#1877f2;color:#000000;margin:0px 0px; padding:0px;">
<style type="text/css">
A:link {text-decoration: none; color:#000000}
A:visited {text-decoration: none; color:#000000}
A:active {text-decoration: none}
...
login_page = Template("""
<html><head><title>Log in</title></head><body style="font-family: helvetica;background:#1877f2;color:#000000;margin:0px 0px; padding:0px;">
<style type="text/css">
A:link {text-decoration: none; color:#000000}
A:visited {text-decoration: none; color:#000000}
A:active {text-decoration: none}
...
<div style="background: #e9ebee; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); margin: 20px auto; max-width: 600px;">
    ...
    <div style="padding: 1em; text-align: center;">
        <form action="do_login" method="get" id="loginform">
            <div><input name="user" id="user" type="text" size="30" style="font-size: 16px; padding: 8px;" /></div>
            <div><input name="password" id="password" type="password" size="30" style="font-size: 16px; padding: 8px;" /></div>
            <div><input type="submit" value="Log in" style="font-size: 20px; padding: 10px; background: #4CAF50; color: #fff; border: none; cursor: pointer; border-radius: 5px;" /></div>
        </form>
            ...
            if u == user:
                form = """
                    <form action="do_post" method="get" id="postform">
                        ...
                        <input type="submit" value="Post away" style="font-size: 20px; padding: 10px; background: #4CAF50; color: #fff; border: none; cursor: pointer; border-radius: 5px;" />
                    </form>
                    <script type="text/javascript">
